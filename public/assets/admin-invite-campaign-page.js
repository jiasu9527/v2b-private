(function () {
    ...
    function formatPeriod(period) {
        if (!period) return '--';
        return PERIOD_LABELS.hasOwnProperty(period) ? PERIOD_LABELS[period] : period;
    }
        ...
        var rows = state.list.length ? state.list.map(function (item) {
            ...
            return '' +
                '<tr>' +
                    ...
                    '<td>' + escapeHtml(item.plan_name || '--') + '<div class="campaign-subvalue">' + escapeHtml(formatPeriod(item.period)) + '</div></td>' +
            ...
            '<div class="campaign-split" style="margin-top:20px;">' +
                '<div class="campaign-card">' +
                    ...
                    '<div style="margin-top:16px;">' +
                        ...
                        '<div class="campaign-kv"><div class="campaign-kv-key">目标套餐</div><div class="campaign-kv-value">' + escapeHtml(detail.plan && detail.plan.name || '--') + ' / ' + escapeHtml(formatPeriod(detail.period)) + '</div></div>' +
