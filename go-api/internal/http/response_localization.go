...
var exactErrorMessages = map[string]string{
	...
	"Payment checkout is being created. Please wait and retry.": "支付单正在创建，请稍后重试，请勿重复点击",
	"Payment checkout is being created. Please wait before cancelling the order.":                                "支付单正在创建，请稍后再取消订单",
	"Payment configuration changed after this order's first checkout attempt. Cancel it and create a new order.": "支付配置已更新，请取消当前订单后重新下单",
