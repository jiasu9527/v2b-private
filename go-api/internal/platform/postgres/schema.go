...
updated_at INTEGER NOT NULL,
PRIMARY KEY (id),
CONSTRAINT uniq_v2_client_entry_user_policy UNIQUE (email, server_type, server_id)
)`,
	} {
	...
	for _, stmt := range []string{
		...
		`CREATE INDEX IF NOT EXISTS idx_v2_client_entry_user_policy_email ON v2_client_entry_user_policy(lower(email))`,
