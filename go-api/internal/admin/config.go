...
func (s *DBService) FetchConfig(_ context.Context, key string) (map[string]any, error) {
	...
	data := map[string]any{
		...
		"subscribe_guard": map[string]any{
			"subscribe_guard_enable":                  cfg.int64Value("subscribe_guard_enable", 0),
			"subscribe_guard_ip_whitelist":            cfg.stringSliceValue("subscribe_guard_ip_whitelist", []string{}),
			"subscribe_guard_ip_blacklist":            cfg.stringSliceValue("subscribe_guard_ip_blacklist", []string{}),
			"subscribe_guard_ua_whitelist":            cfg.stringSliceValue("subscribe_guard_ua_whitelist", []string{"clash", "surge", "sing-box", "singbox", "shadowrocket", "stash", "hiddify"}),
			"subscribe_guard_ua_blacklist":            cfg.stringSliceValue("subscribe_guard_ua_blacklist", []string{"curl", "wget", "python", "go-http-client"}),
			"subscribe_guard_token_blacklist":         cfg.stringSliceValue("subscribe_guard_token_blacklist", []string{}),
			...
			"subscribe_guard_sensitive_enable":        cfg.int64Value("subscribe_guard_sensitive_enable", 0),
			"subscribe_guard_sensitive_rules":         cfg.stringSliceValue("subscribe_guard_sensitive_rules", []string{}),
			"subscribe_guard_sensitive_interval":      cfg.int64Value("subscribe_guard_sensitive_interval", 60),
			"subscribe_guard_sensitive_log_ip":        cfg.int64Value("subscribe_guard_sensitive_log_ip", 1),
			"subscribe_guard_sensitive_log_keep_days": cfg.int64Value("subscribe_guard_sensitive_log_keep_days", 7),
		},
		...
		"server": map[string]any{
			...
			"server_block_check_url":           cfg.stringValue("server_block_check_url", "https://baidu.com/"),
